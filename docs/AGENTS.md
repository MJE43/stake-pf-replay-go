...
> Primary reference for developers and AI agents working with this codebase.

**Related Documents:**
- [Documentation Index](./INDEX.md) — Full documentation catalog
- [Design Constraints](./design-constraints.md) — Backend constraints (CI-enforced)
- [codex-cloud-env.md](./codex-cloud-env.md) — Codex agent environment setup
- [ngrok.md](./ngrok.md) — Service tunneling guide
