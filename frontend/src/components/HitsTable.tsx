  ...
  return (
    <div className="rounded-xl border border-border bg-card/90 p-6 shadow-md">
      ...
      <div className="mt-6 overflow-hidden rounded-lg border border-border/60 bg-card/60">
        <table className="min-w-full border-separate border-spacing-0 text-sm text-foreground/80">
          <thead className="bg-muted/70 text-xs uppercase tracking-[0.2em] text-muted-foreground">
            <tr>
              ...
              <th className="px-3 py-2 text-left font-semibold text-foreground/70">Metric</th>
              <th className="px-3 py-2 text-left font-semibold text-foreground/70">Delta</th>
            </tr>
          </thead>
          <tbody>
            {data.map((hit) => (
              <tr
                ...
                className="border-b border-border/40 bg-card/40 transition-colors last:border-0 hover:bg-muted/40"
              >
                <td className="px-3 py-2 font-mono text-xs text-foreground/70">{hit.nonce.toLocaleString()}</td>
                <td className="px-3 py-2 font-mono text-xs text-foreground/70">{hit.metric.toFixed(6)}</td>
